...
import { IconClosedIcon } from "@gaaamii/ui/icons/IconClosed";
import { PencilSquareIcon } from "@gaaamii/ui/icons/PencilSquare";
import { CodeBracketIcon } from "@gaaamii/ui/icons/CodeBracket";
    ...
    <header className="w-full py-4 px-8 border-b">
      <nav className="w-2/3 m-auto flex items-center justify-between">
        <h1 className="flex gap-2">
          <IconClosedIcon /> blog-editor.gaaamii.jp の管理画面
        </h1>
