...
"[project]/apps/site/pages/api/mock/posts.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = async (req, res)=>{
    ...
    if (req.method === "GET") {
        res.status(200).json((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$site$2f$mocks$2d$post$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["buildPosts"])());
        return;
    }
    if ([
        "POST",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e1223a68._.js.map