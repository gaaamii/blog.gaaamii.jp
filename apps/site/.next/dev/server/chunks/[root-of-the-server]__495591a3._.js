...
"[project]/apps/site/pages/api/mock/admin/posts/[id].ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = async (req, res)=>{
    ...
    if (req.method === "GET") {
        res.status(200).json((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$site$2f$mocks$2d$post$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["buildPost"])(req.body.post));
        return;
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__495591a3._.js.map