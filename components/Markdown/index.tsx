...
const pComponent = ({ children }) => (
   <p className={"mt-6 leading-8"}>{children}</p>
)
const aComponent = ({ node, children, href }) => (
   <a className={"font-bold underline hover:text-sky-600"} href={href} target="blank_">{children}</a>
)