...
import { CloudinaryResponseJson, postImageToCloudinary } from '../../utils/cloudinary';
    ...
    <div className="p-2 rounded-sm border">
      <details>
        ...
        <div className="pt-2 pb-4">
          <div className="mt-2">
            <input type="file" className="border w-full" onChange={onSelectFile} />
          </div>
          <div className="flex justify-end mt-2">
            <div>
              <Button type="button" onClick={onUpload} disabled={isUploading}>画像をアップロードする</Button>
            </div>
          </div>
          <div className="mt-2">
            {url && (
                <div className="mt-4 p-2 border flex justify-center bg-slate-100">
